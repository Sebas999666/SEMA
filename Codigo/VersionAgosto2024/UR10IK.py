...
theta1 = np.radians(-68.35)
theta2 = np.radians(-119.84)
theta3 = np.radians(-129.46)
theta4 = np.radians(-20.55)
theta5 = np.radians(89.59)
theta6 = np.radians(26.31)
...
#sol=invKine(location,th)
#locsol = HTrans(sol.reshape((6,1)),c )

#print(location)
#print(locsol,sol.shape)
